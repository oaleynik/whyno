...
- **macOS**: `~/Library/Application Support/com.whyno.whyno/wines.json`
- **Linux**: `~/.local/share/whyno/wines.json` (or `$XDG_DATA_HOME/whyno/wines.json`)
- **Windows**: `%APPDATA%\whyno\whyno\data\wines.json`
